              ...
              <div class="col-md-8 col-md-offset-2">
                <div class="probootstrap-slider-text text-center probootstrap-animate probootstrap-heading">
                  ...
                  <i><font color="#fff" size="4">Please fill in Envelope # and Cheque #.</font></i><br><br>
                    <form action="user_view_cheque_details.php" method="POST" class="popup-form">
                    <?php
                    ...
                    <table width="60%">
                      <tr>
                        <td width="45%"><font color="#fff" size="4">Envelope #</font></td><td width="5%"> : </td><td><font color="#fff" size="4"><?php echo $envelop_no; ?><input type="hidden" class="form-control form-white" maxlength="12" name="envelop_no" value='<?php echo $envelop_no; ?>'></font></td>
                      </tr>
                      <tr>
                        <td width="45%"><font color="#fff" size="4">Cheque #</font></td><td width="5%"> : </td><td><font color="#fff" size="4"><?php echo $cheque_no; ?><input type="hidden" class="form-control form-white" maxlength="12" name="cheque_no" value='<?php echo $cheque_no; ?>'></font></td>
                      </tr>
                    </table>
                    ...
                    <tr>
                    <td>
                    <input type="hidden" class="form-control form-white" maxlength="12" name="cheque" value='Cheque'><br>
                    </td>
                    <tr>
                    <td>
                    <input type="text" class="form-control form-white" maxlength="12" name="amount" placeholder="Amount" ><br>
                    </td>
                    </tr>
                    </table>
                    ...
                    <table width="60%">
                      <tr>
                        <td align="left"><input type="submit" value=" Next " class="btn btn-success btn-lg"><br><br></td>
