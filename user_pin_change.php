            ...
            <div class="row">
              <div class="col-md-8 col-md-offset-2">
                <div class="probootstrap-slider-text text-center probootstrap-animate probootstrap-heading">
                  ...
                  <center>
                  <i><font color="#fff" size="4">Please fill in NEW PIN Number.</font></i><br><br>
                    <form action="mode_save.php?mode=SavePin" method="POST" class="popup-form">
                      
                      <table width="60%">
                      <tr>
                      <td>
                      <input type="hidden" class="form-control form-white" maxlength="6" name="oc_id" value="<?php echo  $userID['oc_id'] ?>"><br>
                      </td>
                      </tr>
                      <tr>
                      <td>
                      <input type="password" class="form-control form-white" maxlength="6" name="pin_no" placeholder="New PIN Number" required><br>
                      </td>
                      </tr>
                      </table>
                      ...
                      <table width="60%">
                        <tr>
                          <td align="left"><input type="submit" value=" Change " class="btn btn-success btn-lg"><br><br></td>
