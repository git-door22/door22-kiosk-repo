              ...
              <div class="col-md-8 col-md-offset-2">
                <div class="probootstrap-slider-text text-center probootstrap-animate probootstrap-heading">
                  ...
                  <i><font color="#fff" size="4">Please fill in Envelope # and Cheque #.</font></i><br><br>
                    <form action="user_amount_cheque.php" method="POST" class="popup-form">
                    <table width="60%">
                    <tr>
                    <td><input type="hidden" class="form-control form-white" maxlength="name" 12="cheque" value='Cheque'><br>
                    <input type="number" class="form-control form-white" maxlength="12" name="envelop_no" placeholder="Envelop #" ><br></td>
                    </tr>
                    <tr>
                    <td><input type="number" class="form-control form-white" maxlength="12" name="cheque_no" placeholder="Cheque #" ><br></td>
                    </tr>
                    </table>
