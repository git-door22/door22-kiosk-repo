            ...
            <div class="row">
              <div class="col-md-8 col-md-offset-2">
                <div class="probootstrap-slider-text text-center probootstrap-animate probootstrap-heading">
                  ...
                  <center>
                  <i><font color="#fff" size="4">Processing all details.. Please wait..</font></i><br><br>
                    <form action="user_view_cash_details.php" method="POST" class="popup-form">


                      <h1 class="white typed"><font color="#fff">Thank You!</font></h1>
                      <?php include('print_cheque.php'); include('print_cheque_1.php'); ?>
