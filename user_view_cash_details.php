            ...
            <div class="row">
              <div class="col-md-8 col-md-offset-2">
                <div class="probootstrap-slider-text text-center probootstrap-animate probootstrap-heading">
                  ...
                  <center>
                   <i><font color="#fff" size="4">Please review and check all the details.</font></i><br><br>
                    <form action="mode_save.php?mode=SaveCash" method="POST" class="popup-form">
                    <?php
                    ...
                    <table width="50%">
                      ...
                      <tr>
                        <td width="45%"><font color="#fff" size="4">Payment Type</font></td><td width="5%"> : </td><td><font color="#fff" size="4"><?php echo $cash; ?><input type="hidden" class="form-control form-white" maxlength="12" name="cash" value='<?php echo $cash; ?>'></font></td>
                      </tr>
                      <tr>
                    ...
                    <table width="50%">
                      <tr>
                        <td align="left"><input type="submit" value=" Done " name="SaveCash" class="btn btn-success btn-lg"><br><br></td>
